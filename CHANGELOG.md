...
## [3.10.1] - 2026-09-23
- feat(models): add GPT-6 Sol and Luna API pricing (#264) - @jimyag
...
## [3.9.0] - 2026-09-05
- feat(tui): add hourly usage statistics (#248) - @jimyag

## [3.8.0] - 2026-09-04
- feat(tui): add project activity filtering (#244) - @jimyag
- GPT-6 Astra (#246) - @mike1858
- Correct GPT-6 Astra cost accounting (#247) - @mike1858
- Add Claude Fable 5.1 pricing (#245) - @mike1858
...
- fix(codex): restore fallback warning context (#212) - @jimyag
- test: add end-to-end rewrite-retention regression check (#200) (#208) - @lizhuojunx86
- Include Claude Code subagent transcripts (#209) - @mike1858
- Remove unused Codex file path allocation (#213) - @mike1858
