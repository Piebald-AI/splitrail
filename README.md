...
Blazing fast, single-executable, cross-platform, agentic development monitor.  Supports Claude Code, Gemini CLI, and Codex CLI (and more coming soon), and integrates with the Splitrail Leaderboard.  (`ccusage` equivalent for Gemini CLI and Codex CLI, as well as Claude Code.)
