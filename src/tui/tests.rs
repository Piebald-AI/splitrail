#[cfg(test)]
mod tests {
    use crate::tui::{run_app_for_tests, StatsViewMode};
    use crate::tui::logic::*;
    use crate::tui::{
        create_upload_progress_callback, show_upload_error, show_upload_success,
        update_day_filters, update_table_states, update_window_offsets, UploadStatus,
    };
    use crate::types::{
    ...
    fn test_update_window_offsets_and_day_filters_resize() {
        ...
        assert_eq!(
            filters,
            vec![Some("2025-01-01".to_string()), None]
        );
    ...
    fn test_session_aggregate_correctness() {
        ...
        assert_eq!(sessions[0].session_name, Some("Bug Fix Session".to_string()));
    ...
    fn test_session_filtering_by_date_range() {
        ...
        let date3 = Utc.with_ymd_and_hms(2025, 12, 01, 12, 0, 0).unwrap();
    ...
    fn test_single_message_single_session_state() {
        ...
        assert_eq!(sessions[0].session_name, Some("Single Message Session".to_string()));
    }
}
